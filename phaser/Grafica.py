...
# #INGRESO
# narchivo = "C:\\xampp\\htdocs\\phaser\\graficas\\grafica1.csv"
...
df = pd.read_csv('C:\\xampp\\htdocs\\phaser\\graficas\\descarga.csv', header=None, names=['x1', 'x2', 'target'], dtype=float)
